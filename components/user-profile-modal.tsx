...
export function UserProfileModal({ userId, isOpen, onClose, userStatus = "offline" }: UserProfileModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={() => onClose()}>
      <DialogContent className="max-w-md p-0 gap-0 bg-[#0a0a0a] text-white">
          ...
          {loading ? (
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col items-center text-center space-y-2 p-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mt-2">{userProfile.displayName}</h3>
                  <p className="text-gray-400">{userStatus}</p>
                </div>
              </div>
              ...
              <div className="px-4">
                <div className="flex items-center justify-between">
                  <h4 className="text-lg font-medium">Media, links and docs</h4>
                  <Button variant="link" className="text-emerald-500 h-auto p-0">
                    See all
                  </Button>
                </div>
